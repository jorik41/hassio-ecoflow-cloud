# EcoFlow Cloud AI Playground for Home Assistant
...
This repository is a fork of the original project by tolwi — I really appreciate his work! I'm keeping this fork separate because I'm not a programmer and many of the changes here were generated by AI to improve my personal setup. Since I can't reliably judge the quality of the code, I won't be submitting pull requests to the original project. That said, anyone is welcome to use this code, including contributing directly to tolwi's version.
